...
class CellStretcherApp:
    ...
    def create_ui(self):
        ...
        self.port_dropdown.grid(row=0, column=0, sticky="nsew", columnspan=3)
        self.refresh_ports()
        ...
        self.lbl_load_cell_graph.grid(row=0, column=5, sticky="nsew")
        self.lbl_manual_movement = tk.Label(root, text="Manual Movement", font=self.custom_label_font, padx=self.x_pad, pady=self.y_pad)
        self.lbl_manual_movement.grid(row=1, column=2, columnspan=3, sticky="nsew")
        ...
        self.lbl_membrane_parameters.grid(row=4, column=0, columnspan=5, sticky="nsew")
        ...
        self.lbl_cyclic_stretching.grid(row=11, column=0, columnspan=5, sticky="nsew")
        ...
        self.lbl_load_cell1_reading.grid(row=1, column=6, sticky="nsew")
        ...
        self.lbl_load_cell2_reading.grid(row=4, column=6, sticky="nsew")
        ...
        self.lbl_motor1_reading.grid(row=9, column=6, sticky="nsew")
        self.lbl_motor1_position = tk.Label(root, text="", font=self.custom_label_font, padx=self.x_pad, pady=self.y_pad)
        self.lbl_motor1_position.grid(row=9, column=7, sticky="nsew")
        ...
        self.lbl_motor2_reading.grid(row=11, column=6, sticky="nsew")
        self.lbl_motor2_position = tk.Label(root, text="", font=self.custom_label_font, padx=self.x_pad, pady=self.y_pad)
        self.lbl_motor2_position.grid(row=11, column=7, sticky="nsew")
        ...
        self.lbl_motor3_reading.grid(row=13, column=6, sticky="nsew")
        self.lbl_motor3_position = tk.Label(root, text="", font=self.custom_label_font, padx=self.x_pad, pady=self.y_pad)
        self.lbl_motor3_position.grid(row=13, column=7, sticky="nsew")
        ...
        self.lbl_motor4_reading.grid(row=15, column=6, sticky="nsew")
        self.lbl_motor4_position = tk.Label(root, text="", font=self.custom_label_font, padx=self.x_pad, pady=self.y_pad)
        self.lbl_motor4_position.grid(row=15, column=7, sticky="nsew")

        # Create text entry
        self.txt_membrane_size_mm = tk.Entry(root)
        self.txt_membrane_size_mm.grid(row=5, column=3, columnspan=2, sticky="nsew")
        self.txt_strain_target = tk.Entry(root)
        self.txt_strain_target.grid(row=6, column=3, columnspan=2, sticky="nsew")
        self.txt_strain_rate = tk.Entry(root)
        self.txt_strain_rate.grid(row=7, column=3, columnspan=2, sticky="nsew")
        self.txt_number_of_cycles = tk.Entry(root)
        self.txt_number_of_cycles.grid(row=12, column=3, columnspan=2, sticky="nsew")

        # Create buttons
        self.btn_connect = tk.Button(root, text="Connect", font=self.custom_button_font, command=self.btn_connect_click)
        self.btn_connect.grid(row=0, column=3, columnspan=2, sticky="nsew")
        self.btn_home_axes = tk.Button(root, text="Set Zero", font=self.custom_button_font, command=self.btn_home_axes_click)
        self.btn_home_axes.grid(row=1, column=0, columnspan=2, sticky="nsew")
        self.btn_stop = tk.Button(root, text="STOP", font=self.custom_button_font, command=self.btn_stop_click)
        self.btn_stop.grid(row=2, column=0, rowspan=2, columnspan=2, sticky="nsew")
        ...
        self.btn_set_parameters.grid(row=8, column=0, columnspan=5, sticky="nsew")
        self.btn_move_to_zero = tk.Button(root, text="Move to 0", font=self.custom_button_font, command=self.btn_move_to_zero_click)
        self.btn_move_to_zero.grid(row=9, column=0, rowspan=2, columnspan=3, sticky="nsew")
        ...
        self.btn_move_to_max.grid(row=9, column=3, rowspan=2, columnspan=2, sticky="nsew")
        ...
        self.btn_start_cyclic_test.grid(row=13, column=0, rowspan=2, columnspan=5, sticky="nsew")
        ...
        self.btn_save_to_file.grid(row=15, column=2, columnspan=3, sticky="nsew")
        ...
        self.scale_manual_movement.grid(row=2, column=2, rowspan=2, columnspan=3, sticky="nsew")
